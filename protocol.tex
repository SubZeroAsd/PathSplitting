...
\fbox{\procedure{}{
	...
	\< \pcind \pcind \text{Query } \FF_{\mathsf{MPMHL}} \text{ on } (\mathsf{lock},\vec{s},U_i^j) \< \\ [-0.15\baselineskip][]
...
\fbox{\procedure{}{
	...
	\< \pcind \text{Compute } \vec{w} \gets \mathsf{lock}_{U_i}((U_r,\vec{s},\{(\cid_i^1, U_i^1,v_i^1,t_i^1),\ldots,(\cid_i^{k_i}, U_i^{k_i},v_i^{k_i},t_i^{k_i})\})) \< \\ [-0.15\baselineskip][]
