...
\fbox{\procedure{}{
	...
	\< \text{Parse } m \text{ as } (U_r,\vec{s},\{(\cid_i^1, U_i^1,v_i^1,t_i^1),\ldots,(\cid_i^{k_i}, U_i^{k_i},v_i^{k_i},t_i^{k_i})\}) \< \\ [-0.15\baselineskip][]
	...
	\< \pcind \pcind \text{Query } \FF_{\mathsf{MPMHL}} \text{ on } (\mathsf{lock},\vec{s},U_i^j,v_i^j) \< \\ [-0.15\baselineskip][]
	...
	\< \pcind \pcind \text{Send } (\mathsf{lock},U_i,(U_r,\vec{s}_i^j,v_i^j)) \text{ to } U_i^j \< \\ [-0.15\baselineskip][]
	\< \pcreturn \vec{w} \<
}}
...
\fbox{\procedure{}{
	...
	\< \text{Receive } (\vec{\td}, \vec{\ell}) \text{ from } \FF_{\mathsf{MPMHL}} \< \\ [-0.15\baselineskip][]
	\< \text{Send } (\mathsf{setup}, U_s, (v,\vec{\td})) \text{ to } U_r \< \\ [-0.15\baselineskip][]
	\< \text{Compute } \vec{w}_s \gets \mathsf{lock}_{U_s}((U_r,\vec{s},\{(\cid_s^1, U_s^1,v_s^1,t_s^1),\ldots,(\cid_s^{k_s}, U_s^{k_s},v_s^{k_s},t_s^{k_s})\})) \< \\ [-0.15\baselineskip][]
...
\fbox{\procedure{}{
	...
	\< \pcind \text{Parse } m^* \text{ as } (U_r,\vec{s}_i,v_i) \< \\ [-0.15\baselineskip][]
	...
	\< \pcind \text{Compute } \vec{w}_i \gets \mathsf{lock}_{U_i}((U_r,\vec{s}_i,\{(\cid_i^1, U_i^1,v_i^1,t_i^1),\ldots,(\cid_i^{k_i}, U_i^{k_i},v_i^{k_i},t_i^{k_i})\})) \< \\ [-0.15\baselineskip][]
	\< \pcind \pcif \vec{w}_i = \bot \pcthen \< \\ [-0.15\baselineskip][]
	\< \pcind \pcind \pcabort \< \\ [-0.15\baselineskip][]
	\< \pcind \text{Set } \vec{w} = \vec{w} \cup \vec{w}_i \text{ and } \vec{s} = \vec{s} \cup \vec{s}_i \< \\ [-0.15\baselineskip][]
	...
	\< \pcind \text{Query } \FF_{\mathsf{MPMHL}} \text{ on } (\mathsf{release},\vec{s},\vec{k},\vec{w}) \< \\ [-0.15\baselineskip][]
