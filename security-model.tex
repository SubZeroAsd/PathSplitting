...
We make use of the generalized payment channel functionality defined in 
\MESSAGEE{Generalized Bitcoin-Compatible Channels paper}, which we denote here as 
$\FF_{\mathsf{GC}}$. This ideal functionality uses internally a ledger functionality, 
denoted as $\LL$, and defined in GUC model. $\LL$ maintains a transaction set $\mathtt{TX}$, 
which stores all the transactions that have happened.
...
\TODOE{Replace the ledger functionality with a more appropriate payment channel functionality.}
