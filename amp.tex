...
\TODOP{List of todos:\\
- Write the scheme and formalize properties\\
- Study the routing approach\\
- Read the boomerang paper. See if we can get the same property\\
- Study whether we achieve ACID properties \\
- Make the scheme to work not only with coins but with arbitrary amounts}
